...
class TritoTriminoFragment : Fragment(), View.OnClickListener {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_trito_trimino, container, false)
    ...
    override fun onClick(v: View?) {
        ...
        when(v!!.id){
            R.id.YperixografimataButton -> navController!!.navigate(R.id.action_tritoTriminoFragment_to_yperixografimaFragment2)
            R.id.EksetaseisButton -> navController!!.navigate(R.id.action_tritoTriminoFragment_to_eksetaseisFragment)
            R.id.DiatrofiButton -> navController!!.navigate(R.id.action_tritoTriminoFragment_to_diatrofiFragment)
            R.id.SinithiesButton -> navController!!.navigate(R.id.action_tritoTriminoFragment_to_sinithiesFragment)
            R.id.SwmaButton -> navController!!.navigate(R.id.action_tritoTriminoFragment_to_swmaFragment)
            R.id.SimptomataButton -> navController!!.navigate(R.id.action_tritoTriminoFragment_to_simptomataFragment)
        }
