...
class DefteroTriminoFragment : Fragment(), View.OnClickListener {
    ...
    override fun onCreateView(
        ...
        val view =  inflater.inflate(R.layout.fragment_deftero_trimino, container, false)
    ...
    override fun onClick(v: View?) {
        ...
        when(v!!.id){
            R.id.YperixografimataButton -> navController!!.navigate(R.id.action_defteroTriminoFragment_to_yperixografimaFragment)
            R.id.EksetaseisButton -> navController!!.navigate(R.id.action_defteroTriminoFragment_to_eksetaseisFragment)
            R.id.DiatrofiButton -> navController!!.navigate(R.id.action_defteroTriminoFragment_to_diatrofiFragment)
            R.id.SinithiesButton -> navController!!.navigate(R.id.action_defteroTriminoFragment_to_sinithiesFragment)
            R.id.SwmaButton -> navController!!.navigate(R.id.action_defteroTriminoFragment_to_swmaFragment)
            R.id.SimptomataButton -> navController!!.navigate(R.id.action_defteroTriminoFragment_to_simptomataFragment)
        }
